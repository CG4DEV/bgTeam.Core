...
if (!(Test-Path $DOTNET_PATH)) 
{
	...
	powershell -NoProfile -ExecutionPolicy unrestricted -Command "&([scriptblock]::Create((Invoke-WebRequest -useb 'https://dot.net/v1/dotnet-install.ps1'))) -Channel 6.0 -Runtime dotnet -InstallDir $CLI_DIR -NoPath"
}
