namespace Trcont.Cud.Domain.Common
{
    ...
    public class RouteForSave //: IRoute
    {
        ...
        public Guid? AddressWarehouse { get; set; }

        /// <summary>
        /// Агент в порту погрузки
        /// </summary>
        ...
        /// Опасность
        /// </summary>
        [RouteServiceParams(124, "8747787a-a806-4244-8695-4a8a02597a67")]
        public Guid? Danger { get; set; }

        /// <summary>
        /// Тип работ
        /// </summary>
        [RouteServiceParams(126, "34e8f785-a5af-4f9c-86c8-b7010d273ec0")]
        public Guid? TypeWork { get; set; }

        /// <summary>
        /// Признак отправления / прибытия
        /// </summary>
        [RouteServiceParams(127, "76fc0eb5-dafa-4ef8-be11-874ed5a460b6")]
        public Guid? SignDepartureArrival { get; set; }

        /// <summary>
        /// Тип комплекса
        /// </summary>
        [RouteServiceParams(128, "d3202246-c1cb-4259-8554-6e422d2950db")]
        public Guid? TypeComplex { get; set; }

        /// <summary>
        /// Терминал оказания услуги
        /// </summary>
        [RouteServiceParams(129, "7167e35f-d752-4123-9e55-63343d91217a")]
